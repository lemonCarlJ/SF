    ...
    public function console( $page = null )
    {
        ...
        if( file_exists( $page_path ) )
        {
            ...
            foreach ( $message as $name => $record )
            {
                ...
                {
                    echo 'Execute : ' . $break;
                    foreach( $record as $locate => $execute )
                    {
                        foreach ( $execute as $module => $method )
                        {
                            echo $space . 'Locate:' . $locate . $space . ' Module:' . $module . $space . ' Method:' . $method . $break;
                        }
                    }
                    echo $break;
                }
